...
emp_2018 = pd.read_csv("CTA_Employees_2018.csv")
emp_2019 = pd.read_csv("CTA_Employees_2019_1.csv")
emp_2020 = pd.read_csv("CTA_Employees_2020_8.csv")
emp_2021 = pd.read_csv("CTA_Employees_2021_9.csv")
emp_2022 = pd.read_csv("CTA_Employees_2022_7.csv")
emp = pd.concat([emp_2018, emp_2019, emp_2020, emp_2021, emp_2022])
